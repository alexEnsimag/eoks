...
- [`synthesis-execution-graphs.md`](synthesis-execution-graphs.md) — execution topology, coordination, reduction, verification and graph-level evaluation, including asymmetric assurance.
